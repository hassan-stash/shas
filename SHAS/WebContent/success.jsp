...
<table>
<tr>
<td><span>Sprinkler power usage unit</span></td><td><input type="text" id="toDate" name="toDate"
					value="<%=strSprinklerPower%>" /></td></tr>
					<tr>
<td><span>Thermostat power usage unit</span></td><td><input type="text" id="toDate" name="toDate"
					value="" /></td></tr>
					<tr>
<td><span>Lighting power usage unit</span></td><td><input type="text" id="toDate" name="toDate"
					value="" /></td></tr>
</table>
...
<div id="leveldiv"><article> <section>
<div class="status">

<table>
<tr>
<td><span>Sprinkler Level :</span></td><td><input type="text" id="toDate" name="toDate"
					value="<%=strSprinklerLevel%>" /></td></tr>
					<tr>
<td><span>Thermostat Level :</span></td><td><input type="text" id="toDate" name="toDate"
					value="" /></td></tr>
					<tr>
<td><span>Lighting Level :</span></td><td><input type="text" id="toDate" name="toDate"
					value="" /></td></tr>
</table>
