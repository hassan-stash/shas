...
String PTodate = (String) request.getAttribute("cPtoDate");
	...
	if (context.getAttribute("rsWater") != null) {

		rsPower = (Hashtable<String, Integer>) context.getAttribute("rsWater");
...
google.load('visualization', '1', {packages: ['gauge']});
      ...
      function drawChart() {
        ...
        var options = {
          ...
          vAxis: {title: 'Date',  titleTextStyle: {color: 'blue'}},
          hAxis: {title: 'Gallons',  titleTextStyle: {color: 'blue'}},
          colors: ['#8B80AE']
        };
...
<form name="reportform" action="WaterUsageServlet" method="post">
