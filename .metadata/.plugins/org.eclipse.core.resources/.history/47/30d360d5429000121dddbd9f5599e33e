...
<%
	...
	if (request.getAttribute("schedulerstatus") == null) {
		btnScheduleValue = "Scheduler Off";
		System.out.println("in if");
		System.out.println(btnScheduleValue);
	} else {

		btnScheduleValue = (String) request
				.getAttribute("schedulerstatus");
		System.out.println("in else" + btnScheduleValue);
		System.out.println(btnScheduleValue);
	}
		...
		<table border="2">
			...
			<tr>
				...
				<td><select name="duration">
					<option value="15" <%if (minfifteen == true) {%> selected="selected"
						<%}%>>15 Min</option>
